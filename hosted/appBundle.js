...
var deleteFavorite = function deleteFavorite(domo) {
  //sendAjax('POST', "/maker", null, domo);
  console.dir("Domo Deleted");
};
...
var FavoritesList = function FavoritesList(props) {
  ...
  var favoriteNodes = props.pokes.map(function (domo) {
    return (/*#__PURE__*/React.createElement("div", {
        key: pokes._id,
        "class": "card",
        style: "width 20rem;"
  ...
  return (/*#__PURE__*/React.createElement("div", {
      className: "domoList"
    }, /*#__PURE__*/React.createElement("h3", null, "Favorites:"), pokeNodes)
  );
};
